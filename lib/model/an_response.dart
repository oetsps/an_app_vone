...
class DataGetNews {
  ...
  DataGetNews(this.id, this.news_type, this.category, this.subcategory, this.city, this.title, this.caption, this.topnews, this.timestamp, this.photo_small, this.photo_medium, this.photo_big, this.original_url);
