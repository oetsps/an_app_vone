...
import '../../../data/mockdata/gallery_dummy.dart';

class DataVideo extends ChangeNotifier {
  ...
  String getNewsListTitle(int idx) {
    ...
    return jsonEncode(VideoDummy.getVideoDummy[idx]['title']).replaceAll("\"", "");
  }
  ...
  String getNewsListCaption(int idx) {
    ...
    return jsonEncode(VideoDummy.getVideoDummy[idx]['caption']).replaceAll("\"", "");
  }
  ...
  String getNewsListCategory(int idx) {
    ...
    return TopikCategory[topik.index];
  }
  ...
  String urlNewsListPhotoSmall(int idx) {
    ...
    return jsonEncode(VideoDummy.getVideoDummy[idx]['photo']).replaceAll("\"", "");
  }
  ...
  String getSingleNewsHtml() {
    ...
    return jsonEncode(VideoDummy.getVideoDummy[topik.index]['content']).replaceAll("\"", "");
  }

  // USE FOR DUMMY
  String getSinglePhotoMedium() {
    // return SingleNewsDummy.getSingleNewsDummy[TopikCategory[topik.index]]['photo_medium'];
    return jsonEncode(VideoDummy.getVideoDummy[topik.index]['photo']).replaceAll("\"", "");
  }
