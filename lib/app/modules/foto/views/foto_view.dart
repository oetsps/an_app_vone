...
import 'foto_content.dart';

// Berita Screen
class FotoView extends StatefulWidget {
  const FotoView({Key? key}) : super(key: key);
  @override
  State<FotoView> createState() => _FotoViewState();
}

class _FotoViewState extends State<FotoView> with SingleTickerProviderStateMixin {
  late AppTopik topik;
            ...
            child: Scaffold(
              body: Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: FotoNewsList(tabController: _tabController, tabList: tabList, pageState: pageState),
                  ),
                  const BottomBar(),
                ],
              ),
