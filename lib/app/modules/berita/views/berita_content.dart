                          ...
                          children: [
                            Expanded(
                              child: GestureDetector(
                                ...
                                onTap: (() => Navigator.of(context).push(MaterialPageRoute(
                                    builder: (BuildContext context) {
                                      return SingleNewsPage(postData: postData,idx: 1);
                                    }
                                ))),
                                child: Image.network(
                          ...
                          children: [
                            Expanded(
                              child: GestureDetector(
                                ...
                                onTap: (() => Navigator.of(context).push(MaterialPageRoute(
                                    builder: (BuildContext context) {
                                      return SingleNewsPage(postData: postData,idx: 2);
                                    }
                                ))),
                                child: Image.network(
                          ...
                          children: [
                            Expanded(
                              child: GestureDetector(
                                ...
                                onTap: (() => Navigator.of(context).push(MaterialPageRoute(
                                    builder: (BuildContext context) {
                                      return SingleNewsPage(postData: postData,idx: 3);
                                    }
                                ))),
                                child: Image.network(
                          ...
                          children: [
                            Expanded(
                              child: GestureDetector(
                                ...
                                onTap: (() => Navigator.of(context).push(MaterialPageRoute(
                                    builder: (BuildContext context) {
                                      return SingleNewsPage(postData: postData,idx: 4);
                                    }
                                ))),
                                child: Image.network(
                          ...
                          children: [
                            Expanded(
                              child: GestureDetector(
                                ...
                                onTap: (() => Navigator.of(context).push(MaterialPageRoute(
                                    builder: (BuildContext context) {
                                      return SingleNewsPage(postData: postData,idx: 5);
                                    }
                                ))),
                                child: Image.network(
                          ...
                          children: [
                            Expanded(
                              child: GestureDetector(
                                ...
                                onTap: (() => Navigator.of(context).push(MaterialPageRoute(
                                    builder: (BuildContext context) {
                                      return SingleNewsPage(postData: postData,idx: 6);
                                    }
                                ))),
                                child: Image.network(
                          ...
                          children: [
                            Expanded(
                              child: GestureDetector(
                                ...
                                onTap: (() => Navigator.of(context).push(MaterialPageRoute(
                                    builder: (BuildContext context) {
                                      return SingleNewsPage(postData: postData,idx: 7);
                                    }
                                ))),
                                child: Image.network(
                          ...
                          children: [
                            Expanded(
                              child: GestureDetector(
                                ...
                                onTap: (() => Navigator.of(context).push(MaterialPageRoute(
                                    builder: (BuildContext context) {
                                      return SingleNewsPage(postData: postData,idx: 8);
                                    }
                                ))),
                                child: Image.network(
